...
// import the (toast) library from (react-hot-toast) package:
...
const Signup = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (!name || !email || !password || !confirmPassword) {
      ...
      // IMP = we create (notification):with the help of (toast) function:
    ...
    if (password !== confirmPassword) {
      toast.error("make sure password and confirm password field matches");
      error = true;
    }
